...
class VTLetterFormController extends GetxController {
  ...
  void resetFormFields() {
    ...
    totalDayController.value = '';
    totalDayError.value = false;
    subjectController.value = null;
    subjectError.value = false;
    vtSubjectId.value = '';
    vtLocationIds = '';
    vtLocationIdsError.value = false;
    items.clear();
    selectedItems.clear();

    // Refresh UI after resetting form fields
    update();
  }
}
...
/// this controller code is for the rive animation for the refreshing the UI
/*
import 'dart:convert';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
...
/*
///
this controller is based on the Rive animation
import 'dart:convert';
